...
class Automobil:
    ...
    def ispis(self):
        print(f"Marka: {self.marka}, Model: {self.model}, Godina proizvodnje: {self.godina_proizvodnje}, Kilometraža: {self.kilometraža} km")
...
#2. Definirajte klasu Kalkulator s atributima a i b . Dodajte metode zbroj , oduzimanje , mnozenje , dijeljenje , potenciranje i korijen 
#   koje će izvršavati odgovarajuće operacije nad atributima a i b.
...
manager = Manager("Marko", "Voditelj", 8000, "IT")
radnik.work()
manager.work()
