...
#3. Koristeći list comprehension, izgradite listu rječnika gdje su ključevi brojevi od 1 do 10, 
#   a vrijednosti su kubovi tih brojeva, ali samo za neparne brojeve, za parne brojeve neka vrijednost bude sam broj
...
#6. Koristeći dictionary comprehension, izgradite rječnik gdje su ključevi brojevi od 1 do 10, 
